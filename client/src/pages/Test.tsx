            ...
            {phase === 'start' && (
              <div className="text-center">
                ...
                <div className="space-y-3">
                  ...
                  <Button onClick={handleBackToHome} variant="outline" className="w-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-semibold py-3 px-6 rounded-xl transition-colors duration-200">
                    홈으로 돌아가기
                  </Button>
                </div>
              </div>
            ...
            {phase === 'results' && result && (
              <div className="text-center">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <Button onClick={handleBackToHome} className="w-full bg-primary hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-200 flex items-center justify-center space-x-2">
                    <Home size={18} />
